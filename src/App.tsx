		...
		<UserProvider>
			<div className="min-h-screen bg-gray-50">
				...
				<Routes>
					...
					<Route
						path="/simple-appointment-test"
						element={<SimpleAppointmentTest />}
					/>{" "}
					<Route path="/minimal-doctor-list" element={<MinimalDoctorList />} />{" "}
					<Route path="/debug-user-service" element={<DebugUserService />} />{" "}
					<Route path="/auth-test" element={<AuthTestComponent />} />{" "}
					<Route path="/direct-doctor-test" element={<DirectDoctorFetchTest />} />
